...
if (system == 'Darwin'):
    ...
    os.system("mkdir dist;cd dist;svn checkout https://github.com/derrick921213/fake-python/trunk/done/mac-main;svn checkout https://github.com/derrick921213/fake-python/trunk/commands;mv commands mac-main")
